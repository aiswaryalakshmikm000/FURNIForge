...
>(({ side = "left", variant = "sidebar", collapsible = "offcanvas", className, children, ...props }, ref) => {
  ...
  return (
    ...
    >
      ...
      <div
        className={cn(
          "fixed inset-y-0 z-50 flex h-svh w-[--sidebar-width] bg-sidebar transition-transform duration-200 ease-linear",
          side === "left"
            ? state === "collapsed"
              ? "-translate-x-full"
              : "translate-x-0"
...
const SidebarSeparator = ({ className }: { className?: string }) => {
  return <div className={cn("h-px bg-sidebar-border mx-2", className)} />;
};
