      ...
      <form className="space-y-4" onSubmit={handleSubmit(onSubmit)}>
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <div>
            ...
            <Input {...register("firstName")} placeholder="John" className="mt-1.5" />
          ...
          <div>
            ...
            <Input {...register("lastName")} placeholder="Doe" className="mt-1.5" />
        ...
        <div>
          ...
          <Input type="email" {...register("email")} placeholder="john@example.com" className="mt-1.5" />
        ...
        <div>
          ...
          <Input type="tel" {...register("phone")} placeholder="98765 43210" className="mt-1.5" />
        ...
        <div>
          ...
          <div className="relative">
            <Input type={showPw ? "text" : "password"} {...register("password")} placeholder="Create a strong password" className="mt-1.5 pr-10" />

            <button type="button" onClick={() => setShowPw(!showPw)} className="absolute right-3 top-1/2 -translate-y-1/2 mt-1 text-muted-foreground">
        ...
        {/* Submit */}
        <Button type="submit" variant="copper" className="w-full mt-2" size="lg" disabled={!isValid || isPending} >
